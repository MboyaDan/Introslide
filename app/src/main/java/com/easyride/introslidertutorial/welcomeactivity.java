...
public class welcomeactivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] layouts = new int[]{R.layout.activity_intro_slide1, R.layout.activity_intro_slide2, R.layout.activity_intro_slide3, R.layout.activity_intro_slide4};
